...
POST /pass/
```
Καθιστά blocked τον παίχτη που το κάλεσε για να μην έρθει ξανά η σειρά του μέχρι το τέλος του παιχνιδιού και επιστρέφει το ταμπλό. Σε περίπτωση που είναι το τέταρτο πάσο, το παιχνίδι θα τελειώσει και θα γίνει η καταμέτρηση των πόντων.
#### Move
