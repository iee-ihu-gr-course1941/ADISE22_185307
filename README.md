...
| check_part_sidetoside  | Ο παίχτης δεν θα πρέπει να μπορεί να παίξει ένα τουβλάκι σε θέση που θα ακομπάει πλευρά με πλευρά ένα άλλο του τουβλάκι. Έτσι, η move_part καλεί αυτή τη function για να προσπελάσει της θέσεις που πρόκειται να τοποθετηθεί το τουβλάκι, και αν ανιχνεύσει κάποιο τουβλάκι ίδιου χρώματος σε κάποιες από τις θέσεις που θα ακουμπάν πλευρά με πλευρά, η κίνηση δεν θα πραγματοποιηθεί.  | Επιστρέφει 0 αν ανιχνεύσει τουβλάκι ίδιου χρώματος, αλλιώς 1 |
