# BLOKUS
### Μπορεότε να βρείτε την υλοποίηση του παιχνιδιού στην σελίδα https://users.it.teithe.gr/~it185307/ADISE22_185307/www/blokus.php/board
...
### Η υλοποίηση των τούβλων υλοποιήθηκε με τα εξής ονόματα και κατευθύνσεις:
![parts](https://user-images.githubusercontent.com/72744212/210248905-5ffd054e-6174-4b0e-bd77-697cae58a74b.png)
...
```
POST /move/:x/:y/:part_name/:orientation
```
...
| block_state | Αν η θέση με τις συντεταγμένες είναι πιασμένη έχουμε 'Τ', αλλιώς null  | 'Τ', null |
